...
Page({
  ...
  itemClick:function(e){
    ...
    let url = type == 'media' ? '/pages/index/video/video' :'/pages/showProduct/productDetail/productDetail'
    wx.navigateTo({
      url: url+'?id=' + id
    })
  },
  loadData:function(lastId=0){
    ...
    wx.request({
      url: app.globalData.url + '/index.php?s=/Admin/Interface/getMyPraises',
      data: {
        id: lastId,
